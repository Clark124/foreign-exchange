...
export class MACDTooltipCustom extends Component {
    constructor(props) {
        super(props);
        ...
        return (
            <g className={className} transform={`translate(${ x }, ${ y })`} onClick={onClick}>
                <ToolTipText x={0} y={0}
                    ...
                    <ToolTipTSpanLabel fill={appearance.stroke.macd}>MACD </ToolTipTSpanLabel>
                    <tspan fill={labelFill}>({options.slow},{options.fast},{options.signal}) </tspan>
                    <ToolTipTSpanLabel fill={appearance.stroke.macd}> MACD </ToolTipTSpanLabel>
                    <tspan fill={labelFill}>{macd}</tspan>
                    <ToolTipTSpanLabel fill={appearance.stroke.signal}> Signal </ToolTipTSpanLabel>
                    <tspan fill={labelFill}>{signal}</tspan>
                    <ToolTipTSpanLabel fill={appearance.fill.divergence}> Divergence </ToolTipTSpanLabel>
                    <tspan fill={labelFill}>{divergence}</tspan>
                </ToolTipText>
            </g>
        );
    }
...
MACDTooltipCustom.defaultProps = {
    origin: [0, 0],
