...
import AxisZoomCapture from "react-stockcharts/lib/axes/AxisZoomCapture";
// import Moment from 'moment'

import { first, last, hexToRGBA, isNotDefined, isDefined, identity, zipper, strokeDashTypes, getStrokeDasharray } from "react-stockcharts/lib/utils";
...
function drawEachTickLabel(ctx, tick, result) {
	...
	ctx.beginPath();
	// console.log(tick.value+'----'+format(tick.value))
